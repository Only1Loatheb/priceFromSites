...
namespace promocjaAsus
{
    class MoreleSearch
    {
        ...
        private const string bad = "/procesor-intel-core-i7-6950x-3ghz-25-mb-box-bx80671i76950x-774250/";

        public string getUrlToFirstFromSearchUrl(string search) {
            HtmlDocument doc = web.Load(search);
            return  domain + doc.DocumentNode.SelectSingleNode(first).GetAttributeValue("href", "/procesor-intel-core-i7-6950x-3ghz-25-mb-box-bx80671i76950x-774250/");        
        }
        ...
        public string getUrlToIFromSearchUrl(string search,int n)
        {
            ...
            string selector = String.Format("//*[@id=\"content\"]/div/div[2]/div[2]/div[2]/div[7]/div[{0}]/div/div[{1}]/div/div[2]/div[1]/div[1]/div[2]/a",
                tableNo,rowNo);
         HtmlDocument doc = web.Load(search);
            String cheapestProduct = domain + doc.DocumentNode.SelectSingleNode(selector).GetAttributeValue("href", bad);
